...
namespace Hectic7
{
    ...
    public class BulletPatterns
    {
        ...
        public static Dictionary<string, Func<IBulletPattern[]>> DefaultSets = new Dictionary<string, Func<IBulletPattern[]>>()
        {
            {"Curtain Right",  () => new IBulletPattern[] { LToR, LToR, LToR } },
            {"Curtain Left",  () => new IBulletPattern[] { RToL, RToL, RToL } },
            {"Spin to win",  () => new IBulletPattern[] { SpiralCenter, SpiralCenter, SpiralCenter } },
            {"Aimed",  () => new IBulletPattern[] { LAimed, RAimed, LAimed } },
        };

        public static IBulletPattern LToR { get { return new HorizontalSwipe(DirHorizontal.Right); } }
        public static IBulletPattern RToL { get { return new HorizontalSwipe(DirHorizontal.Left); } }
        public static IBulletPattern SpiralCenter { get { return new SpinCenter(); } }
        public static IBulletPattern LAimed { get { return new BigAimedShot(DirHorizontal.Left); } }
        public static IBulletPattern RAimed { get { return new BigAimedShot(DirHorizontal.Right); } }
    }
